...
description: How to request Enterprise Support for LocalStack for Azure.
template: doc
sidebar:
    order: 4
tags: ["Enterprise"]
...
![Customer portal for enterprise support](/images/azure/support/customer-portal.png)
...
![Filing a support ticket](/images/azure/support/file-a-support-ticket.png) 
...
- **Affected Services**: From the dropdown, select the Azure service that is affected in your query.
