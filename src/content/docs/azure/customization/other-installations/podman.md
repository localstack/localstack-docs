---
title: Podman
description: Run LocalStack inside Podman, a Docker-compatible container engine.
template: doc
---
...
- Services that launch their own containers — [Container Instances](/azure/services/container-instance/), [Function Apps](/azure/services/functions-app/) and [AKS](/azure/services/aks/) — require the Docker socket `/var/run/docker.sock` to be mounted into the container.
