...
description: A local Azure Portal served by the emulator itself, letting you browse, create, and manage your emulated Azure resources visually with no extra installation.
template: doc
---
...
It gives you a visual way to work with your emulated resources: browse and filter everything in your local subscription, create resources through guided wizards, inspect blobs and Key Vault secrets, and invoke any ARM operation the emulator implements, all without installing anything beyond the emulator you already run.
