...
The commands that accept an external endpoint are the ones that only *talk to* an already-running emulator: [`aws`](/azure/developer-tools/lstk/cloud-and-iac-commands/#aws), [`az`](/azure/developer-tools/lstk/cloud-and-iac-commands/#az), [`terraform`](/azure/developer-tools/lstk/cloud-and-iac-commands/#terraform)/`tf`, [`cdk`](/azure/developer-tools/lstk/cloud-and-iac-commands/#cdk), [`sam`](/azure/developer-tools/lstk/cloud-and-iac-commands/#sam), [`status`](/azure/developer-tools/lstk/lifecycle-commands/#status), [`reset`](/azure/developer-tools/lstk/lifecycle-commands/#reset), and the [`snapshot`](/azure/developer-tools/lstk/snapshots/) `save`/`load`/`remove` subcommands (including the `lstk save`/`lstk load` aliases) and `list s3://…`.
