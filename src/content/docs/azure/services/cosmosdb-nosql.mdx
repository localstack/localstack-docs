...
This table shows the features currently supported.
...
- **API Support**: Cassandra, Gremlin, and Table APIs are currently unavailable.
...
- **Infrastructure-as-Code**: Bicep and Terraform deployment support is planned, but not supported at this time.
