...
Start your LocalStack container using your preferred method. For more information, see [Introduction to LocalStack for Azure](../getting-started/index.mdx).
...
Create an [Azure storage account](https://learn.microsoft.com/en-us/azure/storage/common/storage-account-overview) for Blob Storage:
...
The following sample demonstrates how to use Blob Storage with LocalStack for Azure:
