...
- **No private DNS resolution**: Private Endpoint is a mock implementation. DNS names are not automatically registered in private DNS zones.
...
The following samples demonstrate how to use Private Endpoints with LocalStack for Azure:
