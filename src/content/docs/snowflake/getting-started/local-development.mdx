...
- A [LocalStack account](https://app.localstack.cloud/sign-up) with a license that includes Snowflake features — see the [Auth Token guide](/snowflake/getting-started/auth-token/).
...
For more on the Web Application's Snowflake tooling, see [User Interface](/snowflake/developer-tools/user-interface/).
