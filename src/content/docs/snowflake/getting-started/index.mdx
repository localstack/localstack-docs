...
Need more options? See our [alternative installation instructions](https://docs.localstack.cloud/aws/getting-started/installation/#alternatives).
...
This will pull and run the correct Docker image automatically.
