...
:::note
**Further reading:** Browse the [Feature Coverage](/snowflake/feature-coverage/) and [Capabilities](/snowflake/capabilities/) pages to see what LocalStack for Snowflake supports beyond this getting-started flow.
:::
