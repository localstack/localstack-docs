...
For the full JSON schema, profile resolution order, and examples, see [Pod Configuration](/aws/advanced-installation/kubernetes/pod-configuration/).
...
| `LOCALSTACK_K8S_POD_CONFIG` | JSON pod configuration for supported child pods. See [Pod Configuration](/aws/advanced-installation/kubernetes/pod-configuration/) |
