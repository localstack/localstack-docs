...
All CLI commands applicable to services implemented within [LocalStack](/aws/connecting-to-localstack/aws-cli/) can be executed when operating against LocalStack.
