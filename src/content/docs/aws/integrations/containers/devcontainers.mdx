...
* From the Command Palette, select **Dev Containers: Add Dev Container configuration file**.
  <br><br>
{/* <img alt="Add Dev Container configuration file" src="01_add_devcontainer_conf.png" width="800px" /> */} {/* mdx-disabled */}
  <br><br>

* Choose **Add configuration to workspace**; alternatively, select **Add configuration to user data folder** for general usage.
  <br><br>
{/* <img alt="Add configuration to workspace" src="02_add_conf_workspace.png" width="800px" /> */} {/* mdx-disabled */}
  <br><br>

* Select **Show All Definitions...** to view community templates.
  <br><br>
{/* <img alt="Show all Template definitions" src="03_show_all_definitions.png" width="800px" /> */} {/* mdx-disabled */}
  <br><br>

* Filter by typing "localstack" in the search bar and select the **LocalStack Docker-in-Docker** template.
  <br><br>
{/* <img alt="Select official LocalStack Template (DinD)" src="04a_select_template_dind.png" width="800px" /> */} {/* mdx-disabled */}
  <br><br>
...
* Proceed through the configuration by selecting or entering values.
  ...
  * Select the image variant (only Debian-based images are supported).
    <br><br>
{/* <img alt="Image variant option" src="05_option_1.png" width="800px" /> */} {/* mdx-disabled */}
    <br><br>
  * Select the log level.
    <br><br>
{/* <img alt="Log level option" src="06_option_2.png" width="800px" /> */} {/* mdx-disabled */}
    <br><br>
  * Select the LocalStack version.
    <br><br>
{/* <img alt="LocalStack version option" src="07_option_3.png" width="800px" /> */} {/* mdx-disabled */}
    <br><br>
...
* Relative paths are acceptable for the volume path, but the specified mount folder must be created prior to building the container.
  <br><br>
{/* <img alt="Volume path option" src="08_volume_option.png" width="800px" /> */} {/* mdx-disabled */}
  <br><br>
{/* <img alt="Volume folder exists" src="09_volume_folder.png" /> */} {/* mdx-disabled */}
  <br><br>
...
* Select various tools and configuration options from the checklist.
  ...
  <br><br>
{/* <img alt="List of options (DinD)" src="10a_options_list_dind.png" width="800px" /> */} {/* mdx-disabled */}
  <br><br>

* You can also add additional features.
  <br><br>
{/* <img alt="Additional Features" src="11_additional_features.png" width="800px" /> */} {/* mdx-disabled */}
  <br><br>

* This results in the following folder structure in your workspace.
  <br><br>
{/* <img alt="Generated folder structure (DinD)" src="12a_folder_structure_dind.png" width="800px" /> */} {/* mdx-disabled */}
  <br><br>
...
* Start typing "localstack" in the search bar to filter the official LocalStack templates and choose **LocalStack Docker-outside-of-Docker**.
  <br><br>
{/* <img alt="Select official LocalStack Template (DooD)" src="04b_select_template_dood.png" width="800px" /> */} {/* mdx-disabled */}
  <br><br>
...
* Select multiple tools and configuration options from the checklist.
  ...
  <br><br>
{/* <img alt="List of options (DooD)" src="10b_options_list_dood.png" width="800px" /> */} {/* mdx-disabled */}
  <br><br>
...
* As a result, you will end up with the folder structure shown below.
  <br><br>
{/* <img alt="Folder structure (DooD)" src="12b_folder_structure_dood.png" width="800px" /> */} {/* mdx-disabled */}
  <br><br>

###### Reference files

{/* {{< tabpane lang="json" >}} */} {/* mdx-disabled */}
{/* {{< tab header="devcontainer.json" lang="json" >}} */} {/* mdx-disabled */}
{
...
{/* {{< tab header="docker-compose.yml" lang="yaml" >}} */} {/* mdx-disabled */}
services:
  localstack:
...
{/* {{< tab header="Dockerfile" lang="dockerfile" >}} */} {/* mdx-disabled */}
FROM mcr.microsoft.com/devcontainers/base:bookworm
{{< /tab >}}
{/* {{< tab header=".env" lang="bash" >}} */} {/* mdx-disabled */}
# Activate LocalStack Pro: https://docs.localstack.cloud/getting-started/auth-token/
