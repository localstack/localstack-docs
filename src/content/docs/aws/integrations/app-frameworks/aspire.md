...
This automatically configures AWS service clients to use the LocalStack endpoint when running locally. See the [.NET](/aws/connecting-to-localstack/aws-sdks/net/) guide for more information.
