...
{/* In case of issues resolving this DNS record, we can fallback to <http://localhost:4566> in combination with the provider setting `ForcePathStyle = true`. */} {/* mdx-disabled */}
...
{/* services.AddAwsService<IAmazonS3>(); */} {/* mdx-disabled */}
}

...

{/* var amazonS3Client = serviceProvider.GetRequiredService<IAmazonS3>(); */} {/* mdx-disabled */}
```
...
{/* var amazonS3Client = session.CreateClientByImplementation<AmazonS3Client>(); */} {/* mdx-disabled */}
```
