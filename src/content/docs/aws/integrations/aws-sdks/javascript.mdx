...
{/* {{< tabpane lang="javascript" >}} */} {/* mdx-disabled */}
{/* {{< tab header="aws-sdk-js" lang="javascript" >}} */} {/* mdx-disabled */}
...
{/* {{< tab header="aws-sdk-js-v3" lang="javascript" >}} */} {/* mdx-disabled */}
...
{/* // -> http://<bucket-name>.s3.localhost.localstack.cloud:4566/<key-name> */} {/* mdx-disabled */}
...
// addressing instead:
{/* // -> http://s3.localhost.localstack.cloud:4566/<bucket-name>/<key-name> */} {/* mdx-disabled */}
// You can read the S3 documentation to learn more about the different endpoints.
...
{/* See [S3 documentation]({{< ref "user-guide/aws/s3" >}}) about endpoints. */} {/* mdx-disabled */}
:::
