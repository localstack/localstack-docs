...
- Continue with the [Local Development guide](/aws/getting-started/local-development/) if you want a guided Lambda and DynamoDB example before adding AI tooling.
