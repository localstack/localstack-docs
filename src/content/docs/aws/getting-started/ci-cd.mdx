...
After choosing your CI provider, continue with the matching integration guide and adapt the example to your test framework, infrastructure tooling, and CI runner model.
