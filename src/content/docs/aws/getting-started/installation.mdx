...
If you want to deploy LocalStack in your [Kubernetes](https://kubernetes.io) cluster, you can use the [LocalStack Operator](/aws/advanced-installation/kubernetes/kubernetes-operator).
