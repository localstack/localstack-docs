...
You may download the binary for your architecture using the links below:
...
<LinkButton
  href={`https://github.com/localstack/localstack-cli/releases/download/v${LOCALSTACK_AWS_VERSION}/localstack-cli-${LOCALSTACK_AWS_VERSION}-darwin-arm64-onefile.tar.gz`}
  icon="download"
  variant="minimal"
>
  Apple Silicon (ARM64)
...
<Code
  code={`curl --output localstack-cli-${LOCALSTACK_AWS_VERSION}-darwin-arm64-onefile.tar.gz \\\n    --location https://github.com/localstack/localstack-cli/releases/download/v${LOCALSTACK_AWS_VERSION}/localstack-cli-${LOCALSTACK_AWS_VERSION}-darwin-arm64-onefile.tar.gz`}
  lang="bash"
/>
