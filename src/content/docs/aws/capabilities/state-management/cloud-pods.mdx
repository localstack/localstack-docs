...
You can save and load the persistent state of Cloud Pods, you can use the [Cloud Pods command-line interface (CLI)](/aws/capabilities/state-management/cli-commands).
...
[Persistence](/aws/capabilities/state-management/persistence) ensures that the service state persists across container restarts.
