...
LocalStack enables you to create and enforce local IAM roles and policies using the [`ENFORCE_IAM` feature](/aws/capabilities/security-testing/iam-enforcement).
