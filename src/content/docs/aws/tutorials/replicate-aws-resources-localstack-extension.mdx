...
- awscli
pro: true
leadimage: "/aws-proxy-tutorial/aws-proxy-extension-tutorial-cover.png"
---
...
- Access [`https://aws-proxy.localhost.localstack.cloud:4566`](https://aws-proxy.localhost.localstack.cloud:4566/) via your web browser.
  ![AWS Cloud Proxy extension](/images/aws/aws-replicator-extension.png)
...
- Save the configuration to enable the AWS Cloud Proxy extension.
  ...
  ![Enabled AWS Cloud Proxy extension](/images/aws/enabled-aws-replicator-extension.png)
