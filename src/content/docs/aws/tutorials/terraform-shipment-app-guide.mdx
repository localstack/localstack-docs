...
- **LocalStack for AWS**
- **Terraform CLI**
- **AWS CLI** with the [`lstk aws`](https://docs.localstack.cloud/aws/connecting/aws-cli/#localstack-aws-cli-lstk-aws) command for LocalStack
...
- Using LocalStack's `lstk aws` and `lstk terraform` commands for streamlined local development.
