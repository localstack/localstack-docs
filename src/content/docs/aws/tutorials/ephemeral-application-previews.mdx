...
With LocalStack's [Ephemeral Instances](/aws/capabilities/cloud-sandbox/ephemeral-instance/), you can create short-lived, self-contained deployments of LocalStack in the cloud.
These Ephemeral Instances also let you deploy your application on a remote LocalStack container, creating an [Application Preview](/aws/capabilities/cloud-sandbox/application-previews/).
