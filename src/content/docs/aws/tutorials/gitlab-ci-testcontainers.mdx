...
description: In this tutorial, we'll walk through the process of setting up end-to-end testing for a backend application using Testcontainers and LocalStack within GitLab. We'll understand the types of GitLab Runners available for CI pipelines and how the concept of Docker-in-Docker plays a crucial role in this environment.
services:
- s3
- lmb
- agw
...
- [LocalStack for AWS](/aws/getting-started/auth-token) to emulate the AWS services.
...
![GitLab architecture](/images/aws/gitlab-architecture.png)
...
![Coffee app diagram](/images/aws/coffee-app-diagram.png)
...
![GitLab CI diagram](/images/aws/gitlab-ci-diagram.png)
...
![CI variable](/images/aws/ci-variable.png)
...
![Pipeline run](/images/aws/pipeline-run.png)
...
![Project runners section](/images/aws/project-runners-section.png)
...
![Runner config](/images/aws/runner-config.png)
