...
Cloud Pods works directly with the [LocalStack CLI](/aws/connecting-to-localstack/aws-cli#localstack-aws-cli-awslocal) to save, merge, and restore snapshots of your LocalStack state.
