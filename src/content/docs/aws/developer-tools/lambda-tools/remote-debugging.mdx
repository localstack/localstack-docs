...
First, make sure that LocalStack is started with the following configuration (see the [Configuration docs](/aws/configuration/config/configuration#lambda) for more information):
