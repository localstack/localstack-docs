...
For more info about remote usage, check our [documentation](/aws/developer-tools/snapshots/cloud-pods/#remotes).
...
Usage: state [OPTIONS] COMMAND [ARGS]...
  ...
  Read more: https://docs.localstack.cloud/aws/developer-tools/snapshots/persistence/
