...
In the [Local Development tutorial](/aws/getting-started/local-development/), you deployed a Lambda function and a DynamoDB table entirely from the command line. We will be using that exact deployment for this quickstart.
...
Specifically, you will use the [LocalStack Web Application](https://app.localstack.cloud/)](https://app.localstack.cloud/) to:
