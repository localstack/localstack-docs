...
Extensions are managed through the LocalStack container, but stored in the [LocalStack volume](/aws/configuration/config/filesystem) on your host.
...
![Extensions Manager](/images/aws/extensions-manager.png)
...
Extensions in LocalStack are Python distributions that operate within their dedicated virtual environment, residing in the [LocalStack Volume](/aws/configuration/config/filesystem).
