...
:::note
To bind to a custom IP address and port, configure the ['GATEWAY_LISTEN' configuration variable](/aws/configuration/config/config-options/#core).
For troubleshooting, refer to the [network troubleshooting docs](/aws/configuration/networking/).
:::