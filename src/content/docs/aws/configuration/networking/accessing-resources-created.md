...
For special environments (e.g., proxies), the [configuration](/aws/configuration/config/config-options) `LOCALSTACK_HOST` customizes the URLs returned by LocalStack.
