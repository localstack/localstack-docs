...
For full details, see [Enterprise Support](/aws/help-support/enterprise-support/).


## Support scope

LocalStack support focuses on helping you use and integrate LocalStack effectively.
