...
The supported APIs are available on our [API Coverage section](#api-coverage), which provides information on the extent of S3's integration with LocalStack.
...
Check out our [SDK documentation]() to learn how you can configure AWS SDKs to access LocalStack and S3.
...
The `ForcePathStyle` parameter name can vary between SDK and languages, please check our [SDK documentation]()
:::
