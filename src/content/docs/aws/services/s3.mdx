...
Check out our [SDK documentation](/aws/tooling/localstack-sdks/) to learn how you can configure AWS SDKs to access LocalStack and S3.
...
The `ForcePathStyle` parameter name can vary between SDK and languages, please check our [SDK documentation](/aws/connecting-to-localstack/aws-sdks/)
:::
...
The LocalStack Web Application provides a [Resource Browser](/aws/connecting-to-localstack/console/resource-browser) for managing S3 buckets & configurations.
