...
The supported APIs are available on our [API Coverage section](#api-coverage), which provides information on the extent of DynamoDB's integration with LocalStack.
...
This guide is designed for users new to DynamoDB and assumes basic knowledge of the AWS CLI and our [`lstk aws`](/aws/developer-tools/running-localstack/lstk/cloud-and-iac-commands/#aws) command.
...
<FeatureCoverage service="dynamodb" client:load />
