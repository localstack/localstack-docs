...
The supported APIs are available on our [API Coverage section](#api-coverage), which provides information on the extent of Support API's integration with LocalStack.

:::note
For technical support with LocalStack, you can reach out through our [support channels](/aws/help-support/get-help/).
...
This guide is designed for users new to Support and assumes basic knowledge of the AWS CLI and our [`lstk aws`](/aws/developer-tools/running-localstack/lstk/cloud-and-iac-commands/#aws) command.
...
<FeatureCoverage service="support" client:load />
