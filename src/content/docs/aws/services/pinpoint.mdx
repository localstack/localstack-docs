...
:::caution
Amazon Pinpoint will be [retired on 30 October 2026](https://docs.aws.amazon.com/pinpoint/latest/userguide/migrate.html) and will be removed from LocalStack soon after this date.
:::
...
The supported APIs are available on our [API Coverage section](#api-coverage), which provides information on the extent of Pinpoint's integration with LocalStack.

## Getting started

This guide is designed for users new to Pinpoint and assumes basic knowledge of the AWS CLI and our [`lstk aws`](/aws/developer-tools/running-localstack/lstk/cloud-and-iac-commands/#aws) command.
...
<FeatureCoverage service="pinpoint" client:load />
