...
To retrieve the Application ID for your SAM application, you can utilize [`lstk aws`](/aws/developer-tools/running-localstack/lstk/aws-and-iac-commands/#aws) by running the following command:
