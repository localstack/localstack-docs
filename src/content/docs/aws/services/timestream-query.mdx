...
The following example illustrates the basic operations, using the [`lstk aws`](/aws/developer-tools/running-localstack/lstk/aws-and-iac-commands/#aws) command line.
