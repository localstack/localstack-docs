...
:::note
With LocalStack version 4.8.0 (and above) we've introduced a **new CloudFormation engine** designed to be more correct when detecting and dispatching updates to resources in a stack.
