...
It allows you to create connections to your code repositories and use them to access your AWS resources.
...
```bash title="Output"
{
    "ConnectionArn": "arn:aws:codeconnections:us-east-1:000000000000:connection/my-connection"
}
```
