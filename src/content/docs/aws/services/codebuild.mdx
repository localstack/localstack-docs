...
It assumes basic knowledge of the [`lstk aws`](/aws/developer-tools/running-localstack/lstk/cloud-and-iac-commands/#aws) command, Apache Maven, and Java.
...
```json {hl_lines=[5,9,16]} showshowLineNumbers
{
...
<FeatureCoverage service="codebuild" client:load />
