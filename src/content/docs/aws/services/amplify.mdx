...
- LocalStack's Amplify API coverage does not include all deployment APIs required for full Amplify Hosting publish flows, such as `CreateDeployment` and `UpdateDeployment`.
