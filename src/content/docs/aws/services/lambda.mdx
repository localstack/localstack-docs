...
- **Lambda VS Code Extension**: LocalStack's Lambda VS Code Extension supports deploying and invoking Python Lambda functions through AWS SAM or AWS CloudFormation.
  To get started with the Lambda VS Code Extension, see our [Lambda VS Code Extension documentation](/aws/connecting-to-localstack/ides/vscode-extension).
...
The LocalStack Web Application provides a [Resource Browser](/aws/connecting-to-localstack/console/resource-browser) for managing Lambda resources.
