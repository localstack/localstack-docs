...
The supported APIs are available on our [API Coverage section](#api-coverage), which provides information on the extent of SNS's integration with LocalStack.
...
<FeatureCoverage service="sns" client:load />
